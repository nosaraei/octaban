...
return [
    ...
    "global" => [
        ...
        "preview" => "مشاهده",
        "verify" => "تایید",
        "excel_download" => "دانلود فایل اکسل",
        "excel_export" => "خروجی اکسل",
        "excel_import" => "درون ریزی با اکسل",
        "no_record" => "اطلاعات یافت نشد",
        "more_details" => "جزئیات بیشتر",
        "bulk_update" => "به روز رسانی گروهی",
        "date" => "تاریخ",
        "time" => "ساعت",
        "created_at" => "زمان ثبت",
        "title" => "عنوان",
        "bulk" => [
            ...
            "active" => "فعال کردن انتخاب شده ها",
            "restore" => "بازگرداندن انتخاب شده ها",
            "inactive" => "غیر فعال کردن انتخاب شده ها",
            "verify" => "تایید کردن انتخاب شده ها",
            "not_verify" => "عدم تایید انتخاب شده ها"
        ],
        "confirm" => [
            "global" => "آیا مطمئن هستید؟",
            "g_delete" => "آیا از حذف گزینه ها مطمئن هستید؟",
            "g_active" => "آیا از فعال کردن گزینه ها مطمئن هستید؟",
            "g_restore" => "آیا از بازگردانی گزینه ها مطمئن هستید؟",
            "g_inactive" => "آیا از غیر فعال کردن گزینه ها مطمئن هستید؟",
            "g_verify" => "آیا از تایید کردن گزینه ها مطمئن هستید؟",
            "g_not_verify" => "آیا از عدم تایید گزینه ها مطمئن هستید؟"
        ],
        "success" => [
            "g_delete" => ":items با موفقیت حذف شدند",
            "g_active" => ":items با موفقیت فعال شدند",
            "g_restore" => ":items با موفقیت بازگزدانی شدند",
            "g_inactive" => ":items با موفقیت غیر فعال شدند",
            "g_verify" => ":items با موفقیت تایید شدند",
            "g_not_verify" => ":items با موفقیت عدم تایید شدند"
        ],
        "messages" => [
            "selected_empty" => "هیچ گزینه ای انتخاب نشده است",
    ...
    "controller" => [
        ...
        "targetlinks" => [
            ...
            "preview" => "مشاهده لینک",
            "delete" => "حذف لینک",
            "group_delete" => "حذف لینک ها",
            "list" => "لیست لینک ها",
            "manage" => "مدیریت لینک ها"
        ]
    ],
    "model_name" => [
        "targetlink" => [
            "target_type" => "نوع لینک",
            "modal_title" => "جستجوی لینک",
            "prompt" => "جهت پیدا کردن لینک مورد نظر کلیک کنید",
        ]
    ],
];
